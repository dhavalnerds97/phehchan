    ...
    <div className=" bg-neutral-500">
      ...
      >
        ...
        <div className="text-wrap">
          ...
          <h3 className="text-xl font-quicksand">
          ...
          <p className="py-2  font-quicksand">
            ...
            unwavering focus on attention to detail and a relentless dedication
            to brainstorming, we possess the unique ability to craft brands that
            captivate the hearts and minds of consumers, while creating
            campaigns that leave an indelible mark.
          </p>
          <p className="py-2  font-quicksand ">
            Every project we undertake is infused with our passion for
            creativity and our commitment to excellence. Our talented team,
            comprising strategic thinkers, visionary designers, and persuasive
            wordsmiths, collaborates seamlessly to bring forth innovative and
