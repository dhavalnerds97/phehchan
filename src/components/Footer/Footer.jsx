...
const Footer = () => {
  ...
  return (
    <motion.section
      ref={ref}
      className="grid grid-cols-1 items-center px-4 md:px-16 lg:px-32 py-2 w-screen md:p-6 xl:pt-20  lg:grid-cols-2 lg:gap-8 bg-black text-gray-100 text-wrap xl:h-screen relative"
