  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center max-sm:gap-4 flex-col p-4 md:p-12 md:max-w-4xl text-center transition-transform hover:scale-105 duration-500">
        ...
        <p className="py-4 px-6 md:py-12 font-quicksand relative lg:text-3xl text-2xl text-wrap max-w-xl transition-opacity duration-1000  bg-clip-text text-transparent bg-gradient-to-b from-gray-50/80 to-gray-400/70">
