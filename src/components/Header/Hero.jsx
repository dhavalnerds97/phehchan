...
const Hero = () => {
  ...
  return (
    <main
      className={`flex h-screen justify-center text-slate-800 md:h-screen items-center relative bg-white transition duration-500  ${
    ...
    >
      ...
      <div className="flex justify-between items-center max-sm:gap-4 flex-col p-4 md:p-12 md:max-w-4xl text-center transition-transform hover:scale-105 duration-500">
        <h1 className="py-4 relative md:font-medium font-cinzel text-4xl md:text-5xl text-wrap transition-opacity duration-1000">
